...
//
//	mockgen -source=./types.go -destination=./mock/provider.mock.go -package=providermock -typed Provider, Selector, SelectorBuilder
//
...
import (
	...
	domain "github.com/JrMarcco/kuryr/internal/domain"
	provider "github.com/JrMarcco/kuryr/internal/service/provider"
...
func (m *MockProvider) Send(ctx context.Context, n domain.Notification) (domain.SendResp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", ctx, n)
	ret0, _ := ret[0].(domain.SendResp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Send indicates an expected call of Send.
func (mr *MockProviderMockRecorder) Send(ctx, n any) *MockProviderSendCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockProvider)(nil).Send), ctx, n)
...
func (c *MockProviderSendCall) Return(arg0 domain.SendResp, arg1 error) *MockProviderSendCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockProviderSendCall) Do(f func(context.Context, domain.Notification) (domain.SendResp, error)) *MockProviderSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockProviderSendCall) DoAndReturn(f func(context.Context, domain.Notification) (domain.SendResp, error)) *MockProviderSendCall {
...
func (m *MockSelector) Next(ctx context.Context, n domain.Notification) (provider.Provider, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Next", ctx, n)
...
func (mr *MockSelectorMockRecorder) Next(ctx, n any) *MockSelectorNextCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Next", reflect.TypeOf((*MockSelector)(nil).Next), ctx, n)
